// Spindle Speed Device Definitions File.
/* 
...
extern WORD SpindleSpeed;
extern WORD SpindleSpeedHolding;

void InitSpindleDevice(void);

void SpindleDevice(void); 
void SetSpindleSpeed(int32 spd);
