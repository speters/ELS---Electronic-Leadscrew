...
#define JOG_TABLE_SIZE	4

extern int8 NewJogIndex;
extern float32 JogIncrement[JOG_TABLE_SIZE];

void InitMPG_Thread(int8 mode);
void RestoreCurrentJog(void);
void ChangeJogDistance(int8 mode);
void ChangeJogMotor(int8 mode);
void MPG_RunThread(void);
